...
const PLANS = [
  {
    ...
    name: "Free Trial",
    price: 0,
    unit: `for ${trialDays} days`,
    highlight: false,
    desc: `Everything in Pro, free for ${trialDays} days. No card required.`,
    features: [
      "Full agentic chat over your CRM",
      "Connect HubSpot, Salesforce, Gong + more",
      "AmpUp Notetaker",
      "Pre & post-meeting briefs",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Unlimited chats & connected sources",
      "Notetaker on every call",
      "Priority support",
      "24-hour support SLA on reported bugs",
    ],
    cta: "Upgrade to Pro",
...
export const CONFIG = {
  ...
  // Public GitHub repo for the template, used by the "Star on GitHub" CTA. The
  // repo is open source; override per deploy for a fork.
  repoUrl: process.env.NEXT_PUBLIC_GITHUB_REPO_URL || "https://github.com/a79-ai/gtm-agentic-chat",
  onboarding: {
