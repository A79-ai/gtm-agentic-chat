...
import { billingStatus, getAccount, openBillingPortal, startCheckout } from "@/lib/gtm/billing";
    ...
    return (
      <div className="trial-strip ok">
        ...
        {status.trialing ? (
          ...
          <span>
            You’re on the <strong>Pro</strong> plan. Thanks for the support!
          </span>
        )}
    ...
    if (p.id === "trial") {
      onToast(
        status.state === "trialing"
          ...
          : `Your ${CONFIG.billing.trialDays}-day free trial is active 🎉`,
        "success"
      );
      return;
    }
  ...
  return (
    <div className="scroll" style={{ flex: 1 }}>
      <div className="screen-pad" style={{ maxWidth: 1100, margin: "0 auto" }}>
        {CONFIG.billing.enabled && <StatusStrip onManage={openBillingPortal} status={status} />}
            ...
            return (
              <div
                ...
                style={{
                  ...
                  position: "relative",
                  boxShadow: p.highlight ? "0 0 0 3px var(--accent-glow)" : "var(--shadow-sm)",
                }}
              >
                {p.highlight && (
                  <span
                ...
                <div>
                  <div style={{ fontWeight: 600, fontSize: 17, color: "var(--fg-primary)" }}>
                    {p.name}
                  </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 9, flex: 1 }}>
                  {p.features.map((f, i) => (
                    ...
                    >
                      <Icons.Check
                        size={15}
                        style={{ color: "var(--mint-base)", flexShrink: 0, marginTop: 2 }}
                      />
                      {f}
                    </div>
                  ))}
