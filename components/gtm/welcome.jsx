...
export function Welcome({ onLogin, onSignup, onGoogle }) {
  ...
  React.useEffect(() => {
    if (typeof window !== "undefined") {
      localStorage.setItem("ampup-theme", theme);
    }
  }, [theme]);
  const dark = theme === "dark";
  ...
  const T = dark
    ? {
        leftBg: "#1A1917",
        rightBg: "radial-gradient(110% 90% at 72% 8%, #2A2620 0%, #1B1916 58%, #131210 100%)",
        ink: "#FDFCF7",
        body: "#BBB8B0",
        muted: "#878478",
        accent: "#F2B33C",
    ...
    : {
        leftBg: "#FFFFFF",
        rightBg: "radial-gradient(110% 90% at 72% 8%, #F3EFE6 0%, #ECE7DB 55%, #E3DDCD 100%)",
        ink: "#181D27",
        body: "#4C4C4A",
        muted: "#807E78",
        accent: "#B7860F",
        ...
        >
          ...
          >
            ...
            >
              Get started
              <br />
              with <span style={{ color: T.accent }}>AmpUp</span>
            </h1>
            <p
              style={{
                margin: "18px 0 0",
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                cursor: "pointer",
                background: "linear-gradient(180deg, #F8C04A 0%, #F0AE26 100%)",
                color: "#1E1B12",
                fontWeight: 600,
                fontSize: 17,
                display: "flex",
                ...
                justifyContent: "center",
                gap: 10,
                boxShadow: "0 14px 30px -10px rgba(240,174,38,0.5)",
                fontFamily: FONT,
              }}
            >
